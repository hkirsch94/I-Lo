...
public class I_Lo_Script : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        ...
        if (intent == "" && Input.GetKey("a"))
        {
            intent = "Hello";
        }
        else if (intent == "" && Input.GetKey("z"))
        {
            intent = "Bye" ;
        }
        else if (intent == "" && Input.GetKey("t"))
        {
            intent = "ThankYou" ;
        }else if (intent == "" && Input.GetKey("o"))
        {
            intent = "ChangeBooks";
        }
        else if (intent == "" && Input.GetKey("u"))
        {
            intent = "ChangeKitchen" ;
        }
        else if (intent == "" && Input.GetKey("n"))
        {
            intent = "ConditionOfILo" ;
        }
        else if (intent == "" && Input.GetKey("l"))
        {
            intent = "LifeConditionILo" ;
        }
        else if (intent == "" && Input.GetKey("c"))
        {
            intent = "DefinitionCymry" ;
        }
        else if (intent == "" && Input.GetKey("d"))
        {
            intent = "DefinitionBindery" ;
        }
        else if (intent == "" && Input.GetKey("s"))
        {
        ...
        else if (intent == "" && Input.GetKey("h"))
        {
            intent = "DefinitionHendecagon" ;
        }
        else if (intent == "" && Input.GetKey("x"))
        {
            intent = "DefinitionExodontist" ;
        }
        else if (intent == "" && Input.GetKey("j"))
        {
            intent = "VerbalJoke" ;
        }
        else if (intent == "" && Input.GetKey("m"))
        {
            intent = "VerbalMusic" ;
        }
        else if (intent == "" && Input.GetKey("i"))
        {
